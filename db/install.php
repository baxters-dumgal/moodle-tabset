...
function xmldb_tabset_install() {
    global $DB;

    $templates = [
        [
            'name' => 'Basic',
            'tabs' => json_encode(['Welcome', 'About', 'Contacts'])
        ],
        [
            'name' => 'Course',
            'tabs' => json_encode(['Welcome', 'About', 'Outcomes', 'Schedule', 'Assessment', 'Contacts'])
        ],
        [
            'name' => 'Metaskills',
            'tabs' => json_encode(['Welcome', 'About', 'Outcomes', 'Metaskills', 'Schedule', 'Assessment', 'Contacts'])
        ]
    ];
